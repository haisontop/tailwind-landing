...
function Footer(): ReactElement {
  return (
    <footer className="relative pt-14 md:pt-8 pb-6 px-5 md:px-0 bg-black">
      <div className="text-white flex justify-center md:mt-36 md:pb-10 md:mx-80">
        <div className="w-full">
          ...
          <form className="mt-7 md:mt-20">
            ...
            />
            <div className="flex">
              <button className="bg-primary text-black py-3 md:py-5 rounded-full md:text-2xl px-10 md:mt-10 mr-5">
                SUBMIT
              </button>
              <button className="bg-green-100 text-black py-3 md:py-5 rounded-full md:text-2xl px-10 md:mt-10">
                02 9745 9864
              </button>
            </div>
          </form>
